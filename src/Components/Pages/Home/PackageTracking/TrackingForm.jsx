...
const TrackingForm = ({ pack }) => {
    const [trackingInput, setTrackingInput] = useState('');
    const [trackingError, setTrackingError] = useState(false);
    const tracker = pack?.packageTrackingNumber?.trackingNumber;
                ...
                <div className="mt-4">
                    {trackingError ? (
                        ...
                        <div className='text-xl bg-black text-white p-5 font-rancho'>
                            ...
                            <p className='text-green-600 font-bold'>Your Product Is  {pack.update}</p>
                            <p>Sender: {pack.senderName}</p>
                            <p>Recipient: {pack.recipientName}</p>
                            <p>Origin: {pack.origin}</p>
